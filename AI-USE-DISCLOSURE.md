# AI Use & Correction Disclosure

**Project:** Rabbit Hole  
**Repository:** `ibloud/the-rabbit-hole`  
**Disclosure date:** 2026-09-25

## Purpose

This document records where AI assistance was used in the Rabbit Hole prototype, what was verified independently, and what was previously represented too confidently.

## AI assistance used

AI assistance was used to:

- inspect and reason about repository structure and implementation;
- draft and revise Ink narrative logic;
- draft JavaScript rendering logic for room media, choices, and links;
- draft room JSON descriptions, hotspot copy, and interface labels;
- identify and discuss the relationship between narrative design, artist independence, authorship, commodification, and direct support;
- search public sources for factual verification;
- use the Apple Music catalog integration to verify specific Ren track metadata and Apple Music deep links;
- make GitHub repository edits and commits.

AI did **not** independently establish artistic intent, permission, affiliation, endorsement, licensing, or ownership. Those remain human/legal questions.

## Source verification used for the current revision

The current revision verified:
...
## Corrections to earlier AI output

Earlier AI-assisted implementation contained material errors:
...
## What “misrepresentation” means here
...
Before public or commercial use, a human reviewer should verify:

- every external URL and its current ownership;
- permission/licensing for embedded video and other third-party material;
- whether the use of Ren's name, music, likeness, branding, or merch references is authorized;
- whether any wording could reasonably imply Ren's participation, approval, endorsement, or authorship;
- accessibility and content warnings;
- whether the project's interpretation remains fair to the cited sources.

## Provenance principle

**AI assistance is part of the production record, not evidence of artist intent.**

The project should distinguish among:

- **Source fact:** independently verified information from a named source.
- **Project interpretation:** Rabbit Hole's own narrative/design framing.
- **AI-generated proposal:** language or implementation drafted with AI assistance.
- **Human decision:** final editorial, legal, artistic, and publication decisions.

## Change record

This disclosure accompanies the September 25, 2026 correction pass. It should be updated when material AI-generated content, source claims, external links, or attribution language changes.
